#!/usr/bin/env python3
#
# This is a curious solution proposed once by a candidate.
# Far from optimal, but interesting since it doesn't face
# the typical index-out-of-range, missing last iteration...
"""Problem Statement:"""
